...
using Tron.Wallet.Net.ABI;
using Tron.Wallet.Net.ABI.FunctionEncoding;
using Tron.Wallet.Net.ABI.Model;
using Tron.Wallet.Net.Accounts;
using TronNet.Protocol;
using Tron.Wallet.Net.Crypto;
using Base58Encoder = Tron.Wallet.Net.Crypto.Base58Encoder;
...
namespace Tron.Wallet.Net.Contracts {
    class TRC20ContractClient : IContractClient {
        ...
        private long GetDecimals(TronNet.Protocol.Wallet.WalletClient wallet, byte[] contractAddressBytes) {
